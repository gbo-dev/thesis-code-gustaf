...
dag1 = generateDAG(1, rec_depth, Cmin, Cmax, beta, addProb, print);
...
for i = 1:num_tasks
    ...
    [r, Wfmax, Lfmax] = SM_RT(dag, f, m);

    m_i = ceil((Wfmax - Lfmax) / (dag.D - Lfmax));
    m_sum = m_sum + m_i;
...
% if m_sum > m 
%    fprintf('Taskset failed, number of required processors: %d \n', m_sum);
% end 
