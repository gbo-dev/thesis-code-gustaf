...
% TODO: Find out how to "set" number of tasks explicitly
...
for x = 1 : nTasksets
    ...
    % G: Remainder is always 0? => Ucurr will always increase by 0.25 when we've created a taskset
    if rem(x - 1, tasksetsPerU) == 0
        Ucurr = Ucurr + stepU; % G: 0 + 0.25 = 0.25
    end
